...
import TestimonialsCarousel from "./testimonials-carosel";

const TestimonialsSection = () => {
  // Translations
  const t = useTranslations();
  return (
    <section className="text-soft-pink-500 dark:text-maroon-400">
      {/* Heading */}
      <div className="my-10 text-center">
        <h2 className="text-base font-bold">{t("testimonials")}</h2>
